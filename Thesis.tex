...
% My extra LaTeX packages required
\usepackage{pdfpages}
\usepackage{siunitx} 
...
\title  {Sustaining cryosphere-fed irrigation networks with ice reservoirs}
...
\input{Chapters/Religion} % Background Theory

\input{Chapters/Science} % Experimental Setup

\input{Chapters/Habitat} % Influence of location

\input{Chapters/Technology} % Influence of construction strategy

\input{Chapters/Heritage} % Conclusion
...
\lhead{\emph{Paper I}} 
\includepdf[pages=-,pagecommand={},width=\paperwidth, offset=75 -75, scale=5]{Chapters/PaperI.pdf}
...
\lhead{\emph{Paper II}} 
\includepdf[pages=-,pagecommand={},width=\paperwidth, offset=75 -75, scale=5]{Chapters/PaperII.pdf}
...
\lhead{\emph{Paper III}} 
\includepdf[pages=-,pagecommand={},width=\paperwidth, offset=75 -75, scale=5]{Chapters/PaperIII.pdf}

\clearpage  % End of Papers
