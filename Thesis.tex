...
\input{Chapters/Technology} % Influence of fountain

\input{Chapters/Science} % Experimental Setup

\input{Chapters/Habitat} % Influence of location

% \input{Chapters/Design} % Influence of design
...
\lhead{\emph{Paper I}}  
\includepdf[pages=-,pagecommand={},width=\paperwidth, offset=75 -75, scale=5]{Chapters/Paper1.pdf}
